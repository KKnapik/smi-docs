...
This page brings together only the **Intraday zone-detection settings** from **v2.3.0 SMI — Smart Money Indicator — Intraday**.
...
| --- | ---: | --- | --- | --- |
| [Min. Leg-Out Body Size (% of Range)](zone-detection/erc-body-threshold.md) | `40%` | **LEG-OUT** | Requires the Leg-Out body to occupy enough of its complete range. | Requires a more body-dominant Leg-Out, so fewer departures qualify. |
...
| [Min. Leg-Out Range (ATR ×)](zone-detection/erc-range-atr-multiplier.md) | `0.70` | **LEG-OUT** | Requires the complete Leg-Out range to be large enough compared with recent movement. | Requires a larger Leg-Out, so fewer departures qualify. |
